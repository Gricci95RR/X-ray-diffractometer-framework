...
#define DLL_VERSION "Library version for XPS-Q8 Firmware Precision Platform V1.4.x"
 ...
 *            int errorCode
 ***********************************************************************/ 
int __stdcall InstallerVersionGet (int SocketIndex, char * Version) 
{ 
	int ret = -1; 
	char ExecuteMethod[SIZE_EXECUTE_METHOD+1]; 
	char *ReturnedValue = (char *) malloc (sizeof(char) * (SIZE_SMALL+1)); 
	...
	/* Convert to string */ 
	sprintf (ExecuteMethod, "InstallerVersionGet (char *)");
...
/*********************************************************************** 
 * ISRCorrectorCompensateOverrunNumberGet :  Get ISR Corrector Compensate Overrun Number
 *
 *     - Parameters :
 *            int SocketIndex
 *            int *CorrectorOverrunCompensationNumber
 *            int *CorrectorOverrunCompensationMissNumber
 *     - Return :
 *            int errorCode
 ***********************************************************************/ 
int __stdcall ISRCorrectorCompensateOverrunNumberGet (int SocketIndex, int * CorrectorOverrunCompensationNumber, int * CorrectorOverrunCompensationMissNumber) 
{ 
	int ret = -1; 
	char ExecuteMethod[SIZE_EXECUTE_METHOD+1]; 
	char *ReturnedValue = (char *) malloc (sizeof(char) * (SIZE_SMALL+1)); 
	...
	/* Convert to string */ 
	sprintf (ExecuteMethod, "ISRCorrectorCompensateOverrunNumberGet (int *,int *)");
	...
	{ 
		...
		if (pt != NULL) pt = strchr (pt, ',');
		if (pt != NULL) pt++;
		if (pt != NULL) sscanf (pt, "%d", CorrectorOverrunCompensationNumber);
		if (pt != NULL) pt = strchr (pt, ',');
		if (pt != NULL) pt++;
		if (pt != NULL) sscanf (pt, "%d", CorrectorOverrunCompensationMissNumber);
	} 
	if (NULL != ReturnedValue)
		free (ReturnedValue);
...
/*********************************************************************** 
 * ISRCorrectorCompensateOverrunNumberReset :  Reset ISR Corrector Compensate Overrun Number
 *
 *     - Parameters :
 *            int SocketIndex
 *     - Return :
 *            int errorCode
 ***********************************************************************/ 
int __stdcall ISRCorrectorCompensateOverrunNumberReset (int SocketIndex) 
{ 
	int ret = -1; 
	char ExecuteMethod[SIZE_EXECUTE_METHOD+1]; 
	char *ReturnedValue = (char *) malloc (sizeof(char) * (SIZE_SMALL+1)); 
	...
	/* Convert to string */ 
	sprintf (ExecuteMethod, "ISRCorrectorCompensateOverrunNumberReset ()");
