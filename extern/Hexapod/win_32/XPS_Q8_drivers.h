...
DLL int __stdcall InstallerVersionGet (int SocketIndex, char * Version);  /* Return installer version */
...
DLL int __stdcall GroupInitializeNoEncoderReset (int SocketIndex, char * GroupName);  /* Group initialization with no encoder reset */
DLL int __stdcall GroupInitializeWithEncoderCalibration (int SocketIndex, char * GroupName);  /* Group initialization with encoder calibration */
...
DLL int __stdcall PrepareForUpdate (int SocketIndex);  /* Prepare for update controller */
...
DLL int __stdcall ISRCorrectorCompensateOverrunNumberGet (int SocketIndex, int * CorrectorOverrunCompensationNumber, int * CorrectorOverrunCompensationMissNumber);  /* Get ISR Corrector Compensate Overrun Number */
DLL int __stdcall ISRCorrectorCompensateOverrunNumberReset (int SocketIndex);  /* Reset ISR Corrector Compensate Overrun Number */
