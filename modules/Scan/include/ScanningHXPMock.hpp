 ...
 * 
 */
class ScanningHXPMock : public IScanning {
 public:
  ...
  MOCK_METHOD1(updateAxisPosition, void(double position));
  MOCK_METHOD0(getAxisPosition, double());
