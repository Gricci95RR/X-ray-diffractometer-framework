/**
 * @file CrystalStatus.hpp
 * @author Gianmarco Ricci CERN BE/CEM/MRO 2022
 * @brief This file contains an enumeration class that defines the possible states of the Crystal device.
 * @version 0.1
 * @date 2022
 * 
...
#ifndef MODULES_DEVICES_INCLUDE_CRYSTAL_CRYSTALSTATUS_HPP_
#define MODULES_DEVICES_INCLUDE_CRYSTAL_CRYSTALSTATUS_HPP_
...
/**
 * @enum CrystalStatus
 * @brief Enumeration class that defines the possible states of the Crystal device.
 * 
...
#endif  // MODULES_DEVICES_INCLUDE_CRYSTAL_CRYSTALSTATUS_HPP_
