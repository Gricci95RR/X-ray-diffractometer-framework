/**
 * @file XRaySensor/System.hpp
 * @author Gianmarco Ricci CERN BE/CEM/MRO 2022
 * @brief This file contains the Class that defines the state machine of the XRaySensor Device.
 * @version 0.1
 * @date 2022
 * 
...
/**
 * @class System
 * @brief Class that defines the state machine transitions and events of the XRaySensor Device.
 * 
 */
class System{
 private:
