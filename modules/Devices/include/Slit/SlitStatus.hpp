...
#ifndef MODULES_DEVICES_INCLUDE_SLIT_SLITSTATUS_HPP_
#define MODULES_DEVICES_INCLUDE_SLIT_SLITSTATUS_HPP_

namespace slit {

/**
 * @enum SlitStatus
 * @brief Enumeration class that defines the possible states of the Slit device.
 * 
 * The class provides a set of named constants with associated integer values starting from 0.
 * 
 */
enum class SlitStatus {
...
#endif  // MODULES_DEVICES_INCLUDE_SLIT_SLITSTATUS_HPP_
